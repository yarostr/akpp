...
!(function (a) {
  ...
  function (a, b, c) {
    ...
    !(function (g) {
      (e = [c(2)]),
        (d = g),
        void 0 !== (f = "function" == typeof d ? d.apply(b, e) : d) &&
          (a.exports = f);
    })(function (a) {
      return a;
    });
      ...
      function h(b, c) {
        ...
        if ((a.isFunction(b.mask) && (b.mask = b.mask(b)), a.isArray(b.mask))) {
          if (b.mask.length > 1) {
            ...
            return (
              a.each(
                b.numericInput ? b.mask.reverse() : b.mask,
                function (c, e) {
                  g.length > 1 &&
                    (g +=
                      b.groupmarker.end +
      ...
      function i(f, h, j) {
        function o(a, b, c) {
          ...
          var e,
            ...
            k = r();
          do {
            !0 === a && p().validPositions[i]
              ? ((g = p().validPositions[i]),
                (f = g.match),
                (e = g.locator.slice()),
                h.push(!0 === c ? g.input : !1 === c ? f.nativeDef : J(i, f)))
              : ((g = u(i, e, i - 1)),
                (f = g.match),
                (e = g.locator.slice()),
                (!1 === j.jitMasking ||
                  i < k ||
                  ("number" == typeof j.jitMasking &&
                    isFinite(j.jitMasking) &&
                    j.jitMasking > i)) &&
                  h.push(!1 === c ? f.nativeDef : J(i, f))),
              i++;
        ...
        function s(b, c, e, f) {
          var g,
            ...
            k = !1;
          for (p().p = b, g = c - 1; g >= h; g--)
            p().validPositions[g] !== d &&
              ((!0 !== e &&
                ((!p().validPositions[g].match.optionality &&
                  (function (a) {
                  ...
                  !1 === j.canClearPosition(p(), g, r(), f, j))) ||
                delete p().validPositions[g]);
          for (q(!0), g = h + 1; g <= r(); ) {
            for (; p().validPositions[h] !== d; ) h++;
            if ((g < h && (g = h + 1), p().validPositions[g] === d && E(g)))
              g++;
            else {
              var l = u(g);
              !1 === k && i[h] && i[h].match.def === l.match.def
                ? ((p().validPositions[h] = a.extend(!0, {}, i[h])),
                  (p().validPositions[h].input = l.input),
                  delete p().validPositions[g],
                  g++)
                : w(h, l.match.def)
                ? !1 !== D(h, l.input || J(g), !0) &&
                  (delete p().validPositions[g], g++, (k = !0))
                : E(g) || (g++, h--),
                h++;
            }
          }
        ...
        function t(a, b) {
          for (
            ...
            !(
              c.match &&
              ((j.greedy && !0 !== c.match.optionalQuantifier) ||
                ((!1 === c.match.optionality ||
                  !1 === c.match.newBlockMarker) &&
                  !0 !== c.match.optionalQuantifier)) &&
              (g.alternation === d ||
                g.alternation !== c.alternation ||
                (c.locator[g.alternation] !== d &&
                  C(c.locator[g.alternation].toString().split(","), h)))
            ) ||
              (!0 === b &&
                (null !== c.match.fn || /[0-9a-bA-Z]/.test(c.match.def))));
            i++
          );
          return c;
        }
        ...
        function x(b, c, e) {
            ...
            function l(g, i, q) {
              ...
              function s(b, c, e) {
                ...
                if (p().validPositions[b - 1] && e && p().tests[b])
                  for (
                    var h = p().validPositions[b - 1].locator,
                      i = p().tests[b][0].locator,
                      j = 0;
                    j < e;
                    j++
                  )
              ...
              if (k === b && g.matches === d)
                return m.push({ match: g, locator: i.reverse(), cd: o }), !0;
              if (g.matches !== d) {
                if (g.isGroup && q !== g) {
                  ...
                  if (-1 === z || "string" == typeof z) {
                    ...
                    else for (A = 0; A < v.matches.length; A++) D.push(A);
                    for (var E = 0; E < D.length; E++) {
                      if (
                        ...
                        !0 !==
                          (g =
                            l(v.matches[A] || c.matches[A], [A].concat(i), q) ||
                            g) &&
                          g !== d &&
                  ...
                  for (
                    var L = g, M = e.length > 0 ? e.shift() : 0;
                    M < (isNaN(L.quantifier.max) ? M + 1 : L.quantifier.max) &&
                    k <= b;
                    M++
                  ) {
          ...
          if (b > -1) {
            if (c === d) {
              for (
                var q, r = b - 1;
                (q = p().validPositions[r] || p().tests[r]) === d && r > -1;
          ...
          return (
            ...
            c !== d && p().tests[b]
              ? g(a.extend(!0, [], m))
              : ((p().tests[b] = a.extend(!0, [], m)), g(p().tests[b]))
          );
        }
        function y() {
          return (
        ...
        function z(a) {
          return (
            (p().buffer !== d && !0 !== a) || (p().buffer = o(!0, r(), !0)),
            p().buffer
          );
        }
        function A(a, b, c) {
        ...
        function B(b, c, d) {
          switch (j.casing || c.casing) {
            ...
            case "title":
              ...
              b =
                0 === d ||
                (f && f.input === String.fromCharCode(e.keyCode.SPACE))
                  ? b.toUpperCase()
                  : b.toLowerCase();
              break;
            default:
        ...
        function D(b, c, f, g, h, i) {
          ...
          function l(c, e, f) {
            var h = !1;
            return (
              a.each(x(c), function (i, l) {
                for (
                  var n = l.match, o = e ? 1 : 0, t = "", u = n.cardinality;
                  u > o;
                  u--
                )
                  t += H(c - (u - 1));
                if (
                  ...
                  !1 !==
                    (h =
                      null != n.fn
                        ? n.fn.test(t, p(), c, f, j, k(b))
                        : (e === n.def || e === j.skipOptionalPartCharacter) &&
                          "" !== n.def && { c: J(c, n, !0) || n.def, pos: c }))
                ) {
                  var v = h.c !== d ? h.c : e;
                  v =
                    v === j.skipOptionalPartCharacter && null === n.fn
                      ? J(c, n, !0) || n.def
                      : v;
                  var w = c,
                    x = z();
                  if (
                    ...
                    if (
                      (A(!0 === y ? y : y.start, y.end, x),
                      h.pos === d && h.c === d)
                    )
                      return (h.pos = r()), !1;
                    if ((w = h.pos !== d ? h.pos : c) !== c)
                      return (h = a.extend(h, D(w, v, !0, g))), !1;
                  } else if (
                    !0 !== h &&
                    h.pos !== d &&
                    h.pos !== c &&
                    ((w = h.pos), A(c, w, z().slice()), w !== c)
                  )
                    return (h = a.extend(h, D(w, v, !0))), !1;
                  return (
                    (!0 === h || h.pos !== d || h.c !== d) &&
                    (i > 0 && q(!0),
                    m(w, a.extend({}, l, { input: B(v, n, w) }), g, k(b)) ||
                      (h = !1),
                    !1)
                  );
                }
          ...
          function m(b, c, e, f) {
            if (f || (j.insertMode && p().validPositions[b] !== d && e === d)) {
              ...
              for (g = k = b; g <= i; g++) {
                ...
                if (t !== d)
                  for (
                    ...
                    ((null === t.match.fn &&
                      m[g] &&
                      (!0 === m[g].match.optionalQuantifier ||
                        !0 === m[g].match.optionality)) ||
                      null != t.match.fn);

                  ) {
                    if (
                      (u++, !1 === o && h[u] && h[u].match.def === t.match.def)
                    )
              ...
              if (!l)
                return (p().validPositions = a.extend(!0, {}, h)), q(!0), !1;
          ...
          function n(b) {
            ...
            for (c++; c < b; c++)
              p().validPositions[c] === d &&
                (!1 === j.jitMasking || j.jitMasking > c) &&
                ((f = x(c, u(c - 1).locator, c - 1).slice()),
                "" === f[f.length - 1].match.def && f.pop(),
                (e = t(f)) &&
                  (e.match.def === j.radixPointDefinitionSymbol ||
                    !E(c, !0) ||
                    (a.inArray(j.radixPoint, z()) < c &&
                      e.match.fn &&
                      e.match.fn.test(J(c), p(), c, !1, j))) &&
                  !1 !==
                    (v = l(
                      c,
                      J(c, e.match, !0) ||
                  ...
                  (p().validPositions[v.pos || c].generatedInput = !0));
          }
          f = !0 === f;
          var o = b;
          ...
          if (
            (a.isFunction(j.preValidation) &&
              !f &&
              !0 !== g &&
              !0 !== i &&
              (v = j.preValidation(z(), o, c, k(b), j)),
            !0 === v)
          ) {
            if (
              (n(o),
              k(b) && (Q(d, e.keyCode.DELETE, b, !0, !0), (o = p().p)),
              o < p().maskLength &&
                (V === d || o < V) &&
                ((v = l(o, c, f)), (!f || !0 === g) && !1 === v && !0 !== i))
            ) {
              var G = p().validPositions[o];
              if (
                !G ||
                null !== G.match.fn ||
                (G.match.def !== c && c !== j.skipOptionalPartCharacter)
              ) {
                if (
                  (j.insertMode || p().validPositions[F(o)] === d) &&
                  !E(o, !0)
                )
                  for (var I = o + 1, K = F(o); I <= K; I++)
                    if (!1 !== (v = l(I, c, f))) {
                      !(function (b, c) {
                        ...
                        if (e)
                          for (
                            var f = e.locator, g = f.length, h = b;
                            h < c;
                            h++
                          )
                  ...
                  a.each(x(o, y ? y.locator : d, o - 1), function (f, i) {
                    ...
                    for (var k = 0; k < n.length; k++) {
                      ...
                      if (
                        v < n[k] &&
                        (i.na === d ||
                          -1 === a.inArray(n[k], i.na.split(",")) ||
                          -1 === a.inArray(v.toString(), n))
                      ) {
                        p().validPositions[o] = a.extend(!0, {}, i);
                        var A = p().validPositions[o].locator;
                        for (
                          p().validPositions[o].locator[h] = parseInt(n[k]),
                            null == i.match.fn
                              ? (w.input !== i.match.def &&
                                  ((z = !0),
                                  !0 !== w.generatedInput && u.push(w.input)),
                                y++,
                                (p().validPositions[o].generatedInput =
                                  !/[0-9a-bA-Z]/.test(i.match.def)),
                                (p().validPositions[o].input = i.match.def))
                              : (p().validPositions[o].input = w.input),
                            l = o + 1;
                          l < r(d, !0) + 1;
                          l++
                        )
                        ...
                        for (
                          z && u[0] === i.match.def && u.shift(), q(!0), t = !0;
                          u.length > 0;

                        ) {
                          var B = u.shift();
                          if (
                            B !== j.skipOptionalPartCharacter &&
                            !(t = D(r(d, !0) + 1, B, !1, g, !0))
                          )
                            break;
                        }
          ...
          return (
            v && v.pos === d && (v.pos = o),
            (!1 !== v && !0 !== i) ||
              (q(!0), (p().validPositions = a.extend(!0, {}, y))),
            v
          );
        }
        function E(a, b) {
        ...
        function F(a, b) {
          ...
          var d = a;
          for (
            x(c + 1).length > 1 && (o(!0, c + 1, !0), (c = p().maskLength));
            ++d < c &&
            ((!0 === b && (!0 !== v(d).match.newBlockMarker || !E(d))) ||
              (!0 !== b && !E(d)));
        ...
        function G(a, b) {
          ...
          for (
            ;
            --d > 0 &&
            ((!0 === b && !0 !== v(d).match.newBlockMarker) ||
              (!0 !== b &&
                !E(d) &&
                ((c = x(d)),
        ...
        function H(a) {
          return p().validPositions[a] === d
            ? J(a)
            : p().validPositions[a].input;
        }
        function I(b, c, e, f, g) {
          ...
          b !== d &&
            ...
            e === d || (f !== d && "blur" === f.type)
              ...
              : M(b, e),
            !0 === g && ((_ = !0), a(b).trigger("input")));
        }
        function J(b, c, e) {
          if (((c = c || v(b).match), c.placeholder !== d || !0 === e))
            return a.isFunction(c.placeholder)
              ? c.placeholder(j)
              : c.placeholder;
          if (null === c.fn) {
            if (b > -1 && p().validPositions[b] === d) {
              ...
              if (g.length > 1 + ("" === g[g.length - 1].match.def ? 1 : 0))
                for (var i = 0; i < g.length; i++)
                  if (
                    !0 !== g[i].match.optionality &&
                    !0 !== g[i].match.optionalQuantifier &&
                    (null === g[i].match.fn ||
                      f === d ||
                      !1 !== g[i].match.fn.test(f.match.def, p(), b, !0, j)) &&
                    (h.push(g[i]),
        ...
        function K(b, f, g, h, i) {
          function k(a, b) {
            return (
              -1 !== y().slice(a, F(a)).join("").indexOf(b) &&
              !E(a) &&
              v(a).match.nativeDef === b.charAt(b.length - 1)
            );
          }
          var l = h.slice(),
            m = "",
          ...
          if (
                  ...
                  if (!1 !== o && !g && a.isFunction(j.onBeforeWrite)) {
                    ...
                    if (
                      ...
                      A(!0 === w ? w : w.start, w.end, o.buffer),
                        q(!0),
                        o.caret &&
                          ((p().p = o.caret), (o.forwardPosition = o.caret));
                    }
                  }
                }
            }),
            ...
            c.activeElement === b &&
              o &&
              (w = j.numericInput ? G(o.forwardPosition) : o.forwardPosition),
              I(
                b,
                z(),
                w,
                i || new a.Event("checkval"),
                i && "input" === i.type
              );
          }
        }
          ...
          if (e === d)
            return (
              a.setSelectionRange
                ...
                : b.getSelection
                ? ((i = b.getSelection().getRangeAt(0)),
                  (i.commonAncestorContainer.parentNode !== a &&
                    i.commonAncestorContainer !== a) ||
                    ((e = i.startOffset), (f = i.endOffset)))
                : c.selection &&
                  c.selection.createRange &&
                  ((i = c.selection.createRange()),
                  (e =
                    0 -
                    i
                      .duplicate()
        ...
        function O(a) {
          for (
            var b, c = N(), e = a.length, f = p().validPositions[r()];
            c < e &&
            !E(c, !0) &&
            (b = f !== d ? u(c, f.locator.slice(""), f) : v(c)) &&
            !0 !== b.match.optionality &&
            ((!0 !== b.match.optionalQuantifier &&
              !0 !== b.match.newBlockMarker) ||
              (c + 1 === e &&
                "" ===
                  (f !== d ? u(c + 1, f.locator.slice(""), f) : v(c + 1)).match
                    .def));
          ...
          for (
            ;
            (b = p().validPositions[c - 1]) &&
            b &&
            b.match.optionality &&
            b.input === j.skipOptionalPartCharacter;
        ...
        function Q(b, c, f, g, h) {
          ...
          c === e.keyCode.BACKSPACE &&
          (f.end - f.begin < 1 || !1 === j.insertMode)
            ? ((f.begin = G(f.begin)),
              p().validPositions[f.begin] !== d &&
                p().validPositions[f.begin].input === j.groupSeparator &&
                f.begin--)
            : c === e.keyCode.DELETE &&
              f.begin === f.end &&
              ((f.end =
                E(f.end, !0) &&
                p().validPositions[f.end] &&
                p().validPositions[f.end].input !== j.radixPoint
                  ? f.end + 1
                  : F(f.end) + 1),
              p().validPositions[f.begin] !== d &&
                p().validPositions[f.begin].input === j.groupSeparator &&
        ...
        function S(a, b, e) {
          function f() {
            m || (null !== h.fn && i.input !== d)
              ? m &&
                ((null !== h.fn && i.input !== d) || "" === h.def) &&
                ((m = !1), (l += "</span>"))
              : ((m = !0), (l += "<span class='im-static'>"));
          }
          function g(d) {
            (!0 !== d && n !== b.begin) ||
              c.activeElement !== a ||
          ...
          if (W !== d) {
            ...
            if (
              ...
              do {
                ...
                ((V === d || n < V) && (null !== h.fn || "" !== h.def)) ||
                q > n ||
                m
              );
              -1 === l.indexOf("im-caret") && g(!0), m && f();
            }
              ...
              var g = function (b) {
                if (this.inputmask === d && "FORM" !== this.nodeName) {
                  ...
                  if (
                      ...
                      (this.readOnly &&
                        !(
                          ("keydown" === b.type &&
                            b.ctrlKey &&
                            67 === b.keyCode) ||
                          (!1 === j.tabThrough && b.keyCode === e.keyCode.TAB)
                        ))
                    )
                  ) {
                    switch (b.type) {
                    ...
                    return (
                      !1 === i && (b.preventDefault(), b.stopPropagation()), i
                    );
                  }
                  b.preventDefault();
                }
          ...
          da = {
            keydownEvent: function (b) {
              ...
              if (
                ...
                g === e.keyCode.DELETE ||
                (m && g === e.keyCode.BACKSPACE_SAFARI) ||
                (b.ctrlKey &&
                  g === e.keyCode.X &&
                  !(function (a) {
                ...
                b.preventDefault(),
                  ...
                  I(
                    ...
                    p().p,
                    b,
                    d.inputmask._valueGet() !== z().join("")
                  ),
                  d.inputmask._valueGet() === y().join("")
                    ? f.trigger("cleared")
                    : !0 === P(z()) && f.trigger("complete");
                ...
                (g === e.keyCode.HOME && !b.shiftKey) || g === e.keyCode.PAGE_UP
                  ? (b.preventDefault(), M(d, 0, b.shiftKey ? h.begin : 0, !0))
                  : ((j.undoOnEscape && g === e.keyCode.ESCAPE) ||
                      (90 === g && b.ctrlKey)) &&
                    !0 !== b.altKey
                  ? (K(d, !0, !1, T.split("")), f.trigger("click"))
                  : g !== e.keyCode.INSERT || b.shiftKey || b.ctrlKey
                  ? !0 === j.tabThrough && g === e.keyCode.TAB
                    ? (!0 === b.shiftKey
                        ? (null === v(h.begin).match.fn &&
                            (h.begin = F(h.begin)),
                          (h.end = G(h.begin, !0)),
                          (h.begin = G(h.end, !0)))
                        : ((h.begin = F(h.begin, !0)),
                      ...
                      h.begin < p().maskLength &&
                        (b.preventDefault(), M(d, h.begin, h.end)))
                    : b.shiftKey ||
                      (!1 === j.insertMode &&
                        (g === e.keyCode.RIGHT
                          ? setTimeout(function () {
                  ...
                  : ((j.insertMode = !j.insertMode),
                    M(
                      d,
                      j.insertMode || h.begin !== p().maskLength
                        ? h.begin
                        : h.begin - 1
                    ));
              ...
              if (l) {
                ...
                if (
                  ...
                  I(
                    i,
                    s,
                    j.numericInput && r.caret === d ? G(m) : m,
                    b,
                    !0 !== c
                  ),
                    !0 !== c &&
                ...
                if ((b.preventDefault(), c))
                  return !1 !== r && (r.forwardPosition = m), r;
              }
            },
            pasteEvent: function (c) {
              ...
              if (
                (k === (Z ? y().reverse() : y()).slice(0, i.begin).join("") &&
                  (k = ""),
                l === (Z ? y().reverse() : y()).slice(i.end).join("") &&
                  (l = ""),
                Z && ((d = k), (k = l), (l = d)),
              ...
              return (
                K(
                  ...
                  !1,
                  !1,
                  Z ? m.split("").reverse() : m.toString().split("")
                ),
            ...
            inputFallBackEvent: function (b) {
              ...
              if (z().join("") !== d) {
                  ...
                  (function (b, c, d) {
                    if (
                      ("." === c.charAt(d.begin - 1) &&
                        ...
                        (c = c.join(""))),
                      c.charAt(d.begin - 1) === j.radixPoint &&
                        c.length > z().length)
                    ) {
                      var e = new a.Event("keypress");
                      return (
                        (e.which = j.radixPoint.charCodeAt(0)),
                ...
                if (
                  ((d = d.replace(
                    new RegExp("(" + e.escapeRegex(y().join("")) + ")*"),
                    ""
                  )),
                  !1 ===
                    (function (b, c, d) {
                      if (l) {
                        ...
                        if (1 === e.length) {
                          ...
                          return (
                            ...
                            da.keypressEvent.call(
                              b,
                              f,
                              !0,
                              !0,
                              !1,
                              p().validPositions[d.begin - 1]
                                ? d.begin
                                : d.begin - 1
                            ),
                            !1
                ...
                if (i === m || h === k) {
                  if (
                    ((o = { begin: h.length }),
                    h[h.length - 1] !== k[k.length - 1] && (o.begin--, q++),
                    i.length > m.length)
                  )
                    o.end = o.begin;
                  else {
                ...
                if (o.begin < o.end)
                  I(c, z(), o),
                    h.split("")[h.length - 1] !== k.split("")[k.length - 1]
                      ? ((b.which = h.charCodeAt(h.length - 1)),
                        (aa = !1),
                        da.keypressEvent.call(c, b))
                      : (o.begin === o.end - 1 && M(c, G(o.begin + 1), o.end),
                  ...
                  if (-1 === r()) {
                    for (
                      var t = y().join("");
                      null === d.match(e.escapeRegex(t) + "$");

                    )
                      t = t.slice(1);
                    d = d.replace(t, "");
                  }
                  a.isFunction(j.onBeforeMask) &&
                    (d = j.onBeforeMask.call(X, d, j) || d),
                    K(c, !0, !1, d.split(""), b),
                    (function (a, b, c) {
                      var d = M(a).begin,
            ...
            setValueEvent: function (b) {
              ...
              a.isFunction(j.onBeforeMask) &&
                ...
                (T = z().join("")),
                (j.clearMaskOnLostFocus || j.clearIncomplete) &&
                  c.inputmask._valueGet() === y().join("") &&
            ...
            focusEvent: function (a) {
              ...
              j.showMaskOnFocus &&
                (!j.showMaskOnHover || (j.showMaskOnHover && "" === c)) &&
                (b.inputmask._valueGet() !== z().join("")
                  ? I(b, z(), F(r()))
                  : !1 === ba && M(b, F(r()))),
                !0 === j.positionCaretOnTab &&
                  !1 === ba &&
                  "" !== c &&
                  (I(b, z(), M(b)), da.clickEvent.apply(b, [a, !0])),
                (T = z().join(""));
            },
            mouseleaveEvent: function (a) {
              var b = this;
              if (
                ((ba = !1), j.clearMaskOnLostFocus && c.activeElement !== b)
              ) {
                var d = z().slice(),
                  e = b.inputmask._valueGet();
                e !== b.getAttribute("placeholder") &&
                  "" !== e &&
                  (-1 === r() && e === y().join("") ? (d = []) : O(d), I(b, d));
              }
            },
            clickEvent: function (b, e) {
              ...
              setTimeout(function () {
                if (c.activeElement === g) {
                  var a = M(g);
                  if (
                    (e && (Z ? (a.end = a.begin) : (a.begin = a.end)),
                    a.begin === a.end)
                  )
              ...
              if (e.inputmask) {
                ...
                "" !== f &&
                  ...
                  !1 === P(g) &&
                    ...
                    j.clearIncomplete &&
                      (q(), (g = j.clearMaskOnLostFocus ? [] : y().slice()))),
                  I(e, g, d, b)),
                  T !== z().join("") && ((T = g.join("")), c.trigger("change"));
              }
            },
            ...
            submitEvent: function (a) {
              T !== z().join("") && U.trigger("change"),
                j.clearMaskOnLostFocus &&
                  ...
                  Y.inputmask._valueGet() === y().join("") &&
                  Y.inputmask._valueSet(""),
                j.removeMaskOnSubmit &&
          ...
          switch (f.action) {
            ...
            case "unmaskedvalue":
              return (
                (Y !== d && f.value === d) ||
                  ...
                  (ea = (
                    a.isFunction(j.onBeforeMask)
                      ? j.onBeforeMask.call(X, ea, j) || ea
                      : ea
                  ).split("")),
                  K(d, !1, !1, Z ? ea.reverse() : ea),
                  a.isFunction(j.onBeforeWrite) &&
                    j.onBeforeWrite.call(X, d, z(), 0, j)),
                L(Y)
              );
            case "mask":
              !(function (b) {
                ...
                if (
                  ...
                  n &&
                    (Y.hasOwnProperty("inputmode") &&
                      ((Y.inputmode = j.inputmode),
                      Y.setAttribute("inputmode", j.inputmode)),
                    "rtfm" === j.androidHack &&
                      (!0 !== j.colorMask && R(Y), (Y.type = "password"))),
                  !0 === e &&
                    (ca.on(Y, "submit", da.submitEvent),
                    ...
                    n || !0 === j.inputEventOnly
                      ? Y.removeAttribute("maxLength")
                      : (ca.on(Y, "keydown", da.keydownEvent),
                  ...
                  "" !== Y.inputmask._valueGet(!0) ||
                    !1 === j.clearMaskOnLostFocus ||
                    c.activeElement === Y)
                ) {
                  var f = a.isFunction(j.onBeforeMask)
                    ? j.onBeforeMask.call(X, Y.inputmask._valueGet(!0), j) ||
                      Y.inputmask._valueGet(!0)
                    : Y.inputmask._valueGet(!0);
                  "" !== f &&
                    K(Y, !0, !1, Z ? f.split("").reverse() : f.split(""));
                  var h = z().slice();
                  (T = h.join("")),
            ...
            case "format":
              return (
                (ea = (
                  a.isFunction(j.onBeforeMask)
                    ? j.onBeforeMask.call(X, f.value, j) || f.value
                    : f.value
                ).split("")),
                ...
                f.metadata
                  ? {
                      ...
                      metadata: i.call(this, { action: "getmetadata" }, h, j),
                    }
                  : Z
                  ? z().slice().reverse().join("")
                  : z().join("")
              );
            case "isValid":
              f.value
                ? ((ea = f.value.split("")),
                  K(d, !0, !0, Z ? ea.reverse() : ea))
                : (f.value = z().join(""));
              for (
                var fa = z(), ga = N(), ha = fa.length - 1;
                ha > ga && !E(ha);
                ha--
              );
              return (
                fa.splice(ga, ha + 1 - ga), P(fa) && f.value === z().join("")
              );
            case "getemptymask":
              return y().join("");
            case "remove":
              if (Y && Y.inputmask) {
                (U = a(Y)),
                  Y.inputmask._valueSet(
                    j.autoUnmask ? L(Y) : Y.inputmask._valueGet(!0)
                  ),
                  ca.off(Y);
            ...
            case "getmetadata":
              if (a.isArray(h.metadata)) {
                var ia = o(!0, 0, !1).join("");
                return (
                  a.each(h.metadata, function (a, b) {
        ...
        (e.prototype = {
          ...
          defaults: {
            ...
            onBeforePaste: function (b, c) {
              return a.isFunction(c.onBeforeMask)
                ? c.onBeforeMask.call(this, b, c)
                : b;
            },
            onBeforeWrite: null,
            onUnMask: null,
          ...
          mask: function (g) {
            ...
            return (
              "string" == typeof g &&
                (g = c.getElementById(g) || c.querySelectorAll(g)),
              (g = g.nodeName ? [g] : g),
              a.each(g, function (b, c) {
                ...
                g !== d &&
                  ...
                  i.call(c.inputmask, { action: "mask" }));
              }),
          ...
          unmaskedvalue: function (a) {
            return (
              (this.maskset = this.maskset || h(this.opts, this.noMasksCache)),
              i.call(this, { action: "unmaskedvalue", value: a })
            );
          },
          remove: function () {
          ...
          getemptymask: function () {
            return (
              (this.maskset = this.maskset || h(this.opts, this.noMasksCache)),
              i.call(this, { action: "getemptymask" })
            );
          },
          ...
          isComplete: function () {
            return (
              (this.maskset = this.maskset || h(this.opts, this.noMasksCache)),
              i.call(this, { action: "isComplete" })
            );
          },
          getmetadata: function () {
            return (
              (this.maskset = this.maskset || h(this.opts, this.noMasksCache)),
              i.call(this, { action: "getmetadata" })
            );
          },
          isValid: function (a) {
            return (
              (this.maskset = this.maskset || h(this.opts, this.noMasksCache)),
              i.call(this, { action: "isValid", value: a })
            );
          },
          format: function (a, b) {
            return (
              (this.maskset = this.maskset || h(this.opts, this.noMasksCache)),
              i.call(this, { action: "format", value: a, metadata: b })
            );
          },
          analyseMask: function (b, c, f) {
            ...
            function h(b, g, h) {
              ...
              if (c)
                ...
                if (j && !u) {
                  for (
                    var k = j.prevalidator, l = k ? k.length : 0, m = 1;
                    m < j.cardinality;
                    m++
                  ) {
                    var n = l >= m ? k[m - 1] : [],
                    ...
                    b.matches.splice(h++, 0, {
                      ...
                      optionality: b.isOptional,
                      newBlockMarker:
                        i === d || i.def !== (j.definitionSymbol || g),
                      casing: j.casing,
                      ...
                      (l = v.matches.pop()),
                        l.isGroup ||
                          (c &&
                            null === l.fn &&
                            "." === l.def &&
                            (l.fn = new RegExp(l.def, f.casing ? "i" : "")),
                          (r = new g(!0)),
                          r.matches.push(l),
                          (l = r)),
                        v.matches.push(l),
          ...
          numeric: {
            ...
            preValidation: function (b, d, e, f, g) {
              ...
              if (
                ...
                if (-1 !== h)
                  return !0 === g.numericInput ? d === h : { caret: h + 1 };
              }
              return !0;
            },
            postValidation: function (d, e, f) {
              ...
              if (
                ...
                if (
                  ...
                  var p =
                    l[l.length - 1] === f.radixPoint && e.c === f.radixPoint;
                  (l = b(
                    (function (a, b) {
                      var c = "";
                      if (
              ...
              var r = {
                caret:
                  k === c || e.pos !== c ? i + (f.numericInput ? -1 : 1) : i,
                buffer: l,
                ...
                switch (d.type) {
                  ...
                  case "checkval":
                      ...
                      if (
                        ...
                        return (
                          ...
                          g.postValidation(
                            g.min
                              .toString()
                              .replace(".", g.radixPoint)
                              .split(""),
                            { caret: f, dopost: !0, placeholder: "0" },
                            g
                          )
                        );
                    ...
                    return g.postValidation(
                      e,
                      { caret: f, placeholder: "0", event: "blur" },
                      g
                    );
                  case "_checkval":
                    return { caret: f };
                  ...
                  if (!0 === i) {
                    if (
                      ...
                      (j = j.replace(
                        ...
                        (j = j.replace(
                          new RegExp(
                            b.escapeRegex(g.negationSymbol.back) + "$"
                          ),
                          ""
                        ));
                      var k = j.split(g.radixPoint);
                      k.length > 1 &&
                        (k[1] = k[1].replace(/0/g, g.placeholder.charAt(0))),
                        "0" === k[0] &&
                          (k[0] = k[0].replace(/0/g, g.placeholder.charAt(0))),
                        (j = k[0] + g.radixPoint + k[1] || "");
                      var l = d._buffer.join("");
                      for (
                        j === g.radixPoint && (j = l);
                        null === j.match(b.escapeRegex(l) + "$");

                      )
                        l = l.slice(1);
                      (j = j.replace(l, "")),
                        (j = j.split("")),
                        (i = j[e] === c ? { pos: e, remove: e } : { pos: e });
                    }
                  } else
                    f ||
                      a !== g.radixPoint ||
                      d.validPositions[e - 1] !== c ||
                      ((d.buffer[e] = "0"), (i = { pos: e + 1 }));
                  return i;
                },
                cardinality: 1,
              },
            ...
            onUnMask: function (a, c, d) {
              ...
              return (
                ...
                "" !== d.placeholder.charAt(0) &&
                  (e = e.replace(
                    new RegExp(d.placeholder.charAt(0), "g"),
                    "0"
                  )),
                d.unmaskAsNumber
                  ? ("" !== d.radixPoint &&
      ...
      return (
        ...
        b.extendAliases({
          abstractphone: {
            ...
            mask: function (a) {
              return (
                (a.definitions = { "#": b.prototype.definitions[9] }),
                a.phoneCodes.sort(c)
              );
            },
            keepStatic: !0,
      ...
      (b.convertToAbsoluteUrls || f) && (d = u(d)),
        e &&
          (d +=
            ...
            " */");
      var g = new Blob([d], { type: "text/css" }),
        h = a.href;
